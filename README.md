...
| `session_title` | `<owner>/<repo>#<n>: <PR title>` | Title shown in the Jules UI session list. Capped at 120 chars; the default only ever truncates the PR title, never `<owner>/<repo>#<n>`. |
